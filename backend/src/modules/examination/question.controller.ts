...
export class QuestionController {
  ...
  async findAllQuestions(
    ...
    return await this.questionService.findAllQuestions(page, limit, type, format, difficulty, categoryId, bankId);
  }
  ...
  async updateCategory(@Param('id', ParseIntPipe) id: number, @Body() updateCategoryDto: UpdateQuestionCategoryDto) {
  ...
  async createBank(@Body() createBankDto: CreateQuestionBankDto, @User() user: UserEntity) {
  ...
  async updateBank(@Param('id', ParseIntPipe) id: number, @Body() updateBankDto: UpdateQuestionBankDto) {
