 ...
 * This configuration is used for testing in production-like conditions.
 */

import { getConfigValue, getFeatureFlag, type EnvironmentConfig } from './index';
const stagingConfig: EnvironmentConfig = {
  api: {
    baseUrl: getConfigValue<string>('SERVER_URL', 'NEXT_PUBLIC_SERVER_URL', 'https://staging-api.laten.edu/api'),
  ...
  analytics: {
    ...
    trackingId: getConfigValue<string>('ANALYTICS.ID', 'NEXT_PUBLIC_ANALYTICS_ID', 'STAGING-TRACKING-ID'),
    options: {
      anonymizeIp: true,
